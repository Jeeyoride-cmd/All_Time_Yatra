...
const List_Notification = () => {
  ...
  const fetchCities = async () => {
    try {
      const response = await fetch(`${BASE_URL}/list_notification`);
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this notification?")) {
      try {
        const response = await fetch(`${BASE_URL}/delete_notification`, {
          method: "POST",
          headers: {
      ...
      >
        <div className="driver-card-body">
          <div className="headercard">
            <span className="">List Notification</span>
            <a href="/sendNotification" className="addcity">
              Add Notification
            </a>
          </div>
